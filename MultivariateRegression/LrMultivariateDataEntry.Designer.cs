namespace Uk.Org.Adcock.Lr
{
  partial class LrMultivariateDataEntry
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.variablesNumericUpDown = new System.Windows.Forms.NumericUpDown();
      ((System.ComponentModel.ISupportInitialize)(this.grid)).BeginInit();
      ((System.ComponentModel.ISupportInitialize)(this.variablesNumericUpDown)).BeginInit();
      this.SuspendLayout();
      // 
      // fitButton
      // 
      ...
      // 
      this.variablesNumericUpDown.Location = new System.Drawing.Point(222, 19);
      this.variablesNumericUpDown.Minimum = new decimal(new int[] {
            1,
            0,
            0,
            0});
      this.variablesNumericUpDown.Name = "variablesNumericUpDown";
      this.variablesNumericUpDown.Size = new System.Drawing.Size(58, 20);
      this.variablesNumericUpDown.TabIndex = 4;
      this.variablesNumericUpDown.Value = new decimal(new int[] {
            1,
            0,
            0,
            0});
      this.variablesNumericUpDown.ValueChanged += new System.EventHandler(this.variablesNumericUpDown_ValueChanged);
      // 
      // LrMultivariateDataEntry
      // 
      this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
      this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
      this.ClientSize = new System.Drawing.Size(292, 265);
      this.Controls.Add(this.variablesNumericUpDown);
      this.Controls.Add(this.label1);
      this.Controls.Add(this.logYCheckBox);
      this.Controls.Add(this.grid);
      this.Controls.Add(this.fitButton);
      this.Name = "LrMultivariateDataEntry";
      this.Text = "Regression Data Entry";
      this.Load += new System.EventHandler(this.LrMultivariateDataEntry_Load);
      ((System.ComponentModel.ISupportInitialize)(this.grid)).EndInit();
      ((System.ComponentModel.ISupportInitialize)(this.variablesNumericUpDown)).EndInit();
    ...
    private System.Windows.Forms.NumericUpDown variablesNumericUpDown;
  }
}
